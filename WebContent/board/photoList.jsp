...
<main class="photolist_main">
	<c:forEach var="board" items="${boards}">
		<div class="container">
			...
			<a href="${pageContext.request.contextPath}/photo_board?cmd=detail&id=${board.id}" onclick="reload();">
    <img class="container_img" src="${pageContext.request.contextPath}/uploads/${board.photoImage}" style="width: 100%">
</a>
